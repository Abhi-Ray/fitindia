...
const WhatsAppButton = () => {
  const whatsappNumber = "918718074703"; // Replace with actual WhatsApp number
  const message = "Hi! I'm interested in joining Fit India Gym. Can you help me with more information?";
